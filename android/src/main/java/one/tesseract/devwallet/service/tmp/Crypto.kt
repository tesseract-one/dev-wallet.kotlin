...
fun Mnemonics.MnemonicCode.toSubstrateSeed(
    passphrase: String
): ByteArray = PKCS5S2ParametersGenerator(SHA512Digest()).run {
...
fun KeyPair.Companion.fromMnemonic(mnemonic: Mnemonics.MnemonicCode,
